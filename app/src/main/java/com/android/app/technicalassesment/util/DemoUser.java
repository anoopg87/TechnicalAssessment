...
public class DemoUser {
    ...
    public static List<User> getUerList(){
        ...
        users.add(user);
        user=new User("Shine Dowan","Enjoying hollydays","https://d37nk263jfz2p8.cloudfront.net/image/2/100/100/5/uploads/profile/10660395_10202054807365257_158-5551750cdbb44.jpg",true,true);
        users.add(user);
        user=new User("Jhone Cristo","Enjoying rain","https://media.licdn.com/mpr/mpr/shrink_100_100/p/1/000/2a9/25a/2183b01.jpg",true,true);
        users.add(user);
